...
public class TrainingMap : IEntityTypeConfiguration<Training>
{
    public void Configure(EntityTypeBuilder<Training> entity)
    {
        ...
        entity.Property(r => r.ReleaseDate)
            .HasColumnName("DATE")
            .HasColumnType("DATE")
            .HasMaxLength(50)
            .IsRequired();
        ...
        entity.HasData(new[]{
            new Training(1, "https://certificadocursosonline.com/wp-content/uploads/2018/07/Curso-de-Manutenc%CC%A7a%CC%83o-de-Computadores.jpg", "Manutenção de Computadores", "Architecto eaque consectetur nostrum impedit earum at harum. Reiciendis suscipit soluta, ab, repellat ad, Architecto eaque consectetur nostrum impedit earum at harum. Architecto eaque consectetur nostrum impedit earum at harum., Architecto eaque consectetur nostrum impedit earum at harum.", "Carlos Silva", new TimeSpan(20,0,0), true, "tecnologia", new DateTime(2022,12,04)
            ),
            new Training(2, "https://setcesp.org.br/wp-content/uploads/2019/08/treinamento.jpg", "Ingles Basico", "Neste curso, os alunos irão obter um conhecimento aprofundado sobre os recursos disponíveis sobre Inlges o basico.", "Rodrigo Rosa", new TimeSpan(70,0,0), true, "idioma", new DateTime(2022,12,04)
            ),
            new Training(3, "https://setcesp.org.br/wp-content/uploads/2019/08/treinamento.jpg", "Redacao", "Neste curso, os alunos irão obter um conhecimento aprofundado sobre os recursos disponíveis.", "Maria Eduarda", new TimeSpan(18,0,0), true, "educacao", new DateTime(2022,12,04)
            ),
        });
    }
}
